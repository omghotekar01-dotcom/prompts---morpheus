...
from app.startup_readiness_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain_evidence import (
    build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain,
...
def _readdress_chain(record: dict[str, object]) -> dict[str, object]:
    core = {key: value for key, value in record.items() if key != "comparison_extension_chain_extension_chain_extension_chain_sha256"}
...
def _e133_records() -> tuple[dict[str, object], dict[str, object], dict[str, object]]:
...
def test_e133_comparison_chain_replays_deterministically() -> None:
    first, second, third = _e133_records()
    chain = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain([first, second, third])
    replay = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain([first, second, third])
    assert chain == replay
    ...
    assert chain["start_comparison_extension_chain_extension_chain_sha256"] == first["base_comparison_extension_chain_extension_chain_sha256"]
    assert chain["end_comparison_extension_chain_extension_chain_sha256"] == third["candidate_comparison_extension_chain_extension_chain_sha256"]
    ...
    assert verify_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain(chain) == chain


def test_e133_comparison_chain_rejects_minimum_duplicate_and_broken_adjacency() -> None:
    first, second, _ = _e133_records()
    with pytest.raises(ValueError, match="at least two comparison records"):
        build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain([first])
    with pytest.raises(ValueError, match="duplicate comparison identities"):
        build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain([first, first])
    with pytest.raises(ValueError, match="broken structural adjacency"):
        build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain([second, first])


def test_e133_comparison_chain_rejects_nested_tampering_and_summary_forgery() -> None:
    first, second, third = _e133_records()
    chain = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain([first, second, third])
    ...
    with pytest.raises(ValueError, match="comparison digest does not match canonical record"):
        verify_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain(tampered)
    ...
    with pytest.raises(ValueError, match="relation_counts is inconsistent with embedded comparisons"):
        verify_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain(forged)


def test_e133_comparison_chain_rejects_authority_boundaries_and_malformed_identity() -> None:
    first, second, third = _e133_records()
    chain = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain([first, second, third])
    ...
    with pytest.raises(ValueError, match="cannot carry activation authority"):
        verify_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain(authority)
    ...
    with pytest.raises(ValueError, match="truth boundaries are missing"):
        verify_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain(missing)
    ...
    with pytest.raises(ValueError, match="comparison_sha256s is inconsistent with embedded comparisons"):
        verify_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain(malformed)
