...
def _e135_records() -> tuple[dict[str, object], dict[str, object], dict[str, object]]:
    ...
    return first_e135, second_e135, third_e135


def _e136_chains() -> tuple[dict[str, object], dict[str, object], dict[str, object]]:
    first, second, third = _e135_records()
    base = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain_extension_chain(
        [first, second]
    )
    extended = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain_extension_chain(
        [first, second, third]
    )
    divergent = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain_extension_chain(
        [second, third]
    )
...
def test_e136_prefix_comparison_replays_deterministically() -> None:
    ...
    assert first["base_comparison_extension_chain_extension_chain_extension_chain_extension_chain_sha256"] == base[
        "comparison_extension_chain_extension_chain_extension_chain_extension_chain_sha256"
    ]
    assert first["candidate_comparison_extension_chain_extension_chain_extension_chain_extension_chain_sha256"] == extended[
        "comparison_extension_chain_extension_chain_extension_chain_extension_chain_sha256"
    ]
...
def test_e136_prefix_comparison_classifies_identical_and_non_prefix() -> None:
    base, extended, divergent = _e136_chains()
...
def test_e136_prefix_comparison_rejects_nested_tampering_and_semantic_forgery() -> None:
    base, extended, _ = _e136_chains()
...
def test_e136_prefix_comparison_rejects_authority_boundaries_and_malformed_suffix() -> None:
    base, extended, _ = _e136_chains()
    record = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain_extension_chain_extension(
        base, extended
    )
