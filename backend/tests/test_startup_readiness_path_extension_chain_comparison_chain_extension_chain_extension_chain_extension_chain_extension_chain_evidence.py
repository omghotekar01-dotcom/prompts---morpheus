...
def test_e135_comparison_chain_replays_deterministically() -> None:
    ...
    assert chain["start_comparison_extension_chain_extension_chain_extension_chain_sha256"] == first[
        "base_comparison_extension_chain_extension_chain_extension_chain_sha256"
    ]
    assert chain["end_comparison_extension_chain_extension_chain_extension_chain_sha256"] == third[
...
def test_e135_comparison_chain_rejects_nested_tampering_and_summary_forgery() -> None:
    first, second, third = _e135_records()
    chain = build_startup_readiness_coherence_path_extension_chain_comparison_chain_extension_chain_extension_chain_extension_chain_extension_chain(
        [first, second, third]
    )
